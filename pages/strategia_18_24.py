...
def load_data():
    usecols = [
        ...
        ,"High_1m","Low_1m","High_5m","Low_5m","High_90m", "Low_90m", "Volume", "VolumePM", "Volume_30m", "Volume_5m",
        "High_150m", "Low_150m", "High_210m", "Low_210m","High_270m","Low_270m", "High_30m", "Low_30m", "Market Cap"
    ]
