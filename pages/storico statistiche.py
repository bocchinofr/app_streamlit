...
# ---- CONFIGURAZIONE ----
st.set_page_config(page_title="Analisi Storico", layout="wide", initial_sidebar_state="expanded")
...
max_float = st.sidebar.number_input("Sh Outstanding massimo", 0, 1_000_000_000, 50_000_000)
