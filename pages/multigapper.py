...
def ci_card_box(df, label, bg_color="#eaf8ee", suffix="%"):
    ...
    # Creazione grafico con sfondo trasparente
    ...
    fig.update_layout(
        plot_bgcolor="rgba(0,0,0,0)",  # trasparente
    ...
    # Inserisco grafico + KPI dentro un container Streamlit
    with st.container():
