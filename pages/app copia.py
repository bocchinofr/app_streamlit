...
# -------------------------------------------------
# region GRAFICO CLOSE vs OPEN PER TIMEFRAME
# -------------------------------------------------
...
if close_cols and not filtered.empty:
    ...
    # Media per timeframe sui ticker filtrati
    mean_values = (
        filtered[close_cols]
        .mean()
    ...
    fig.update_layout(
        title="Variazione media % del Close rispetto all’Open (multi-ticker)",
